...
{
    public class DroneControlPdu : MonoBehaviour, IDroneControlOp
    {
        ...
        public void DeclarePduAsync(IHakoPdu hakoPdu)
        {
            pdu_manager = hakoPdu.GetPduManager();
            if (pdu_manager == null)
            {
